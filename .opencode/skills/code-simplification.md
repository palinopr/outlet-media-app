...
**When to use:** When you need to review and refactor code to make it simpler, more maintainable, and easier to understand. Helps with identifying overly complex solutions and unnecessary abstractions.
...
- Respect project-specific patterns from AGENTS.md
...
The best code is not the code that does the most, but the code that does exactly what's needed with the least cognitive overhead. Every simplification should make the codebase more approachable for the next developer who reads it.
