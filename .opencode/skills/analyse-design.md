...
**When to use:** When asked to analyse visual design, extract a colour palette, document UI patterns, identify typography and spacing systems, audit design consistency, or understand the design language of a frontend codebase.
...
Use file search and grep to locate these efficiently before reading files.
