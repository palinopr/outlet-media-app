...
**When to use:** After multiple failed debugging attempts on the same complex issue. When dealing with intricate system interactions or when methodical root cause analysis is needed. Do NOT use for simple troubleshooting.
...
4. **Next steps** - proceed to implement the proposed solutions
