...
- Specific and actionable guidance, not generic advice
- Consideration of the existing codebase structure and patterns
- Prioritised maintainability and readability
- Suggested logical groupings that make sense for the domain
- Suggested file names and organisation patterns
