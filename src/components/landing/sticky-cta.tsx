...
export function LandingStickyCTA() {
  ...
  return (
    ...
    >
      <a
        href="#booking"
        className="flex h-12 w-full items-center justify-center gap-2 rounded-[10px] bg-[color:var(--landing-brand)] font-[family-name:var(--font-landing-heading)] text-sm font-bold tracking-wide text-white shadow-[0_14px_40px_-12px_rgba(30,31,184,0.65)] backdrop-blur-md"
      >
        Agenda tu auditoría gratis <span aria-hidden>→</span>
      </a>
    </div>
  );
}
