      ...
      <div className="mx-auto flex max-w-7xl flex-col gap-6 px-4 sm:px-6 lg:flex-row lg:items-end lg:justify-between">
        <div>
          ...
          <p className="mt-4 max-w-md text-sm leading-6 text-slate-400">
            Mobile-first direct-response funnels for Puerto Rico campaigns that need more than
            clicks. The goal is clearer movement toward the call, the lead, and the next sale.
          </p>
        </div>
