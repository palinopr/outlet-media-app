    ...
    return (
      ...
      >
        <div className="mx-auto max-w-[720px]">
          ...
          <p className="mt-6 text-center text-[13px] leading-relaxed text-[color:var(--landing-muted)]">
            ¿Prefieres WhatsApp directo?{" "}
            <a
              href="https://wa.me/13053225709"
              target="_blank"
        ...
        >
          ...
          >
            {pending ? (
              ...
              <>
                Enviar mi cuenta para auditoría <span aria-hidden>→</span>
              </>
            )}
          </button>
          {error ? (
