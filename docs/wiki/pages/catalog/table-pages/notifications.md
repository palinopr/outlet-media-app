...
- Behavior signals from references: calls redirect() (2), client component/module (1)
- Auth signals from references: references membership/scope access concepts (2), imports Clerk server auth (1), calls auth() (1)

## Reference files
- audit/agent-dead-code.md, audit/architecture-smells.md, audit/dead-routes.md, docs/plans/2026-03-02-meta-oauth-integration-plan.md, docs/plans/2026-03-27-shell-reset-implementation-plan.md, docs/superpowers/plans/2026-03-22-outlet-web-reset.md, docs/superpowers/plans/2026-04-02-core-reset-salvage-map.md, docs/superpowers/specs/2026-03-22-web-reset-design.md, docs/superpowers/specs/2026-03-27-shell-reset-design.md, src/app/privacy/page.tsx
