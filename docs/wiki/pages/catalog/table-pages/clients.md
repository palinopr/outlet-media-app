...
- Behavior signals from references: client component/module (16), server action/module (4), calls revalidatePath() (3), sets dynamic rendering mode (2), calls notFound() (1)
- Auth signals from references: references membership/scope access concepts (15), imports Clerk server auth (10), calls currentUser() (2)

## Reference files
- AGENTS.md, README.md, __tests__/features/access/revalidation.test.ts, __tests__/features/clients/summary.test.ts, audit/architecture-smells.md, audit/dead-routes.md, docs/context/engineering-principles.md, docs/context/product-direction.md, docs/context/salvage-map.md, docs/references/database-safety-runbook.md, e2e/authenticated-smoke.spec.ts, src/app/admin/actions/campaigns.ts, src/app/admin/actions/clients.test.ts, src/app/admin/actions/clients.ts, src/app/admin/actions/search.test.ts, src/app/admin/actions/search.ts, src/app/admin/actions/users.ts, src/app/admin/campaigns/data.ts, src/app/admin/campaigns/page.test.tsx, src/app/admin/campaigns/page.tsx, … (+43 more)
