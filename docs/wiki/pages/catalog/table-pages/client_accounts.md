...
- Auth signals from references: references membership/scope access concepts (5), imports Clerk server auth (2)

## Reference files
- docs/references/database-safety-runbook.md, src/app/admin/actions/clients.ts, src/app/admin/clients/data.test.ts, src/app/admin/clients/data.ts, src/app/admin/settings/page.tsx, src/app/api/meta/data-deletion/route.ts, src/lib/database.types.ts
