...
- Agent files: none
- Mutation-oriented files: src/app/admin/actions/audit.ts
- Tests: none
...
- Behavior signals from references: server action/module (2), client component/module (1)
- Auth signals from references: references membership/scope access concepts (4), imports Clerk server auth (3), calls currentUser() (3)

## Reference files
- AGENTS.md, docs/context/engineering-principles.md, docs/plans/2026-03-03-admin-activity-tracking-design.md, docs/plans/2026-03-03-admin-activity-tracking-plan.md, docs/references/database-safety-runbook.md, src/app/admin/actions/audit.ts, src/app/api/admin/activity/route.ts, src/lib/database.types.ts, supabase/AGENTS.md
