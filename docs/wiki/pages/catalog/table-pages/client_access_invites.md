...
- Agent files: none
- Mutation-oriented files: src/app/admin/actions/users.ts
...
- Behavior signals from references: server action/module (1)
- Auth signals from references: references membership/scope access concepts (5), imports Clerk server auth (4)

## Reference files
- docs/references/database-safety-runbook.md, docs/superpowers/plans/2026-03-22-outlet-web-reset.md, src/app/admin/actions/users.ts, src/app/api/admin/invite/route.test.ts, src/app/api/admin/invite/route.ts, src/features/client-portal/entry-accept.test.ts, src/features/client-portal/entry.ts, src/features/invitations/server.ts, src/lib/database.types.ts
