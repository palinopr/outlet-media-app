...
- Auth signals from references: imports Clerk server auth (4), references membership/scope access concepts (3)

## Reference files
- docs/superpowers/plans/2026-03-22-outlet-web-reset.md, src/app/admin/actions/users.ts, src/app/api/admin/invite/route.test.ts, src/app/api/admin/invite/route.ts, src/features/client-portal/entry.ts, src/features/invitations/server.ts, src/lib/database.types.ts
