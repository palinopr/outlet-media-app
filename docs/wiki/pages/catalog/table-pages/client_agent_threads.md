...
## Reference files
- docs/superpowers/plans/2026-03-31-client-agent-tab.md, src/features/client-agent/store.test.ts, src/features/client-agent/store.ts, src/lib/database.types.ts
