...
- Agent files: none
- Mutation-oriented files: src/features/client-agent/store.test.ts, src/features/client-portal/insights.ts
- Tests: none
...
- Behavior signals from references: client component/module (3)
- Auth signals from references: references membership/scope access concepts (3)

## Reference files
- agent/MEMORY.md, agent/scripts/growth-ledger.ts, audit/architecture-smells.md, docs/plans/2026-03-07-discord-growth-team-plan.md, src/app/landing/page.tsx, src/components/landing/contact-form.tsx, src/components/landing/faq.tsx, src/components/landing/hero.tsx, src/features/client-agent/store.test.ts, src/features/client-portal/insights.ts, src/lib/database.types.ts
