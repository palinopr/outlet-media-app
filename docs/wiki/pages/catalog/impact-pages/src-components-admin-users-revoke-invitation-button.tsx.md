...
- DB objects: none
- Env vars: none
- Mutation symbols: RevokeInvitationButton, RevokeInvitationButtonProps
- Auth signals: none
...
- Summary: contains `use client`; exports: RevokeInvitationButton; internal imports: 2; package imports: 2
