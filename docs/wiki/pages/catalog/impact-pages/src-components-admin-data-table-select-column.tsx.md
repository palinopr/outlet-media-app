# Impact: src/components/admin/data-table/select-column.tsx
...
- DB objects: none
- Env vars: none
- Mutation symbols: createSelectColumn
- Auth signals: none
- Behavior signals: client component/module
- Depends on groups: none
- Used by groups: src/components / admin
- Summary: contains `use client`; exports: createSelectColumn; package imports: 1
