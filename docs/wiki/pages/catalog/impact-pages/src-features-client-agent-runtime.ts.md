# Impact: src/features/client-agent/runtime.ts
...
- DB objects: none
- Env vars: ANTHROPIC_API_KEY, CLIENT_AGENT_CLAUDE_MODEL
- Mutation symbols: none
- Auth signals: none
- Behavior signals: none
- Depends on groups: src/features / client-agent
- Used by groups: src/features / client-agent
- Summary: exports: runClientAgentRuntime, ClientAgentRuntimeHistoryMessage, GenerateClientAgentModelResponseInput, ClientAgentModelResponse; internal imports: 6; package imports: 2
