# Impact: src/components/admin/agents/constants.ts
...
- Summary: exports: agentName, AGENT_CONFIG, AGENT_TYPE_KEYS, QUICK_RUN_AGENTS, DASHBOARD_AGENTS, AgentInfo; package imports: 1
