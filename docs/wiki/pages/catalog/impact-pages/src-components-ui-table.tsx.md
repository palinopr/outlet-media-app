# Impact: src/components/ui/table.tsx
...
- Summary: contains `use client`; exports: Table, TableHeader, TableBody, TableFooter, TableHead, TableRow, TableCell, TableCaption; internal imports: 1; package imports: 1
