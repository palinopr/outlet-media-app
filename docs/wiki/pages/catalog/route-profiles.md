...
- [/api/admin/activity](./route-pages/api-admin-activity-route.md) — `src/app/api/admin/activity/route.ts`; features: 0; db objects: 1; tests: 0
- [/api/admin/invite](./route-pages/api-admin-invite-route.md) — `src/app/api/admin/invite/route.ts`; features: 0; db objects: 2; tests: 1
- [/api/admin/users/[id]](./route-pages/api-admin-users-id-route.md) — `src/app/api/admin/users/[id]/route.ts`; features: 0; db objects: 2; tests: 0
- [/api/agent-outcomes/action-item](./route-pages/api-agent-outcomes-action-item-route.md) — `src/app/api/agent-outcomes/action-item/route.ts`; features: 9; db objects: 18; tests: 0
- [/api/agents](./route-pages/api-agents-route.md) — `src/app/api/agents/route.ts`; features: 1; db objects: 3; tests: 1
- [/api/agents/email/watch](./route-pages/api-agents-email-watch-route.md) — `src/app/api/agents/email/watch/route.ts`; features: 0; db objects: 0; tests: 0
- [/api/agents/heartbeat](./route-pages/api-agents-heartbeat-route.md) — `src/app/api/agents/heartbeat/route.ts`; features: 0; db objects: 1; tests: 1
- [/api/agents/job/[id]](./route-pages/api-agents-job-id-route.md) — `src/app/api/agents/job/[id]/route.ts`; features: 0; db objects: 2; tests: 0
- [/api/agents/jobs](./route-pages/api-agents-jobs-route.md) — `src/app/api/agents/jobs/route.ts`; features: 0; db objects: 2; tests: 1
...
- [/api/meta/data-deletion](./route-pages/api-meta-data-deletion-route.md) — `src/app/api/meta/data-deletion/route.ts`; features: 0; db objects: 1; tests: 1
- [/api/ticketmaster/tm1/move-selection](./route-pages/api-ticketmaster-tm1-move-selection-route.md) — `src/app/api/ticketmaster/tm1/move-selection/route.ts`; features: 0; db objects: 0; tests: 1
- [/api/ticketmaster/tm1/request-move-selection](./route-pages/api-ticketmaster-tm1-request-move-selection-route.md) — `src/app/api/ticketmaster/tm1/request-move-selection/route.ts`; features: 0; db objects: 0; tests: 1
- [/api/ticketmaster/tm1/snapshot](./route-pages/api-ticketmaster-tm1-snapshot-route.md) — `src/app/api/ticketmaster/tm1/snapshot/route.ts`; features: 0; db objects: 1; tests: 1
- [/api/user/profile](./route-pages/api-user-profile-route.md) — `src/app/api/user/profile/route.ts`; features: 0; db objects: 0; tests: 0

## Admin surfaces

- [/admin](./route-pages/admin-layout.md) — `src/app/admin/layout.tsx`; features: 0; db objects: 4; tests: 0
- [/admin/agents](./route-pages/admin-agents-loading.md) — `src/app/admin/agents/loading.tsx`; features: 0; db objects: 0; tests: 0
...
- [/](./route-pages/layout.tsx.md) — `src/app/layout.tsx`; features: 0; db objects: 0; tests: 0
...
- [/terms](./route-pages/terms-page.md) — `src/app/terms/page.tsx`; features: 0; db objects: 0; tests: 0
