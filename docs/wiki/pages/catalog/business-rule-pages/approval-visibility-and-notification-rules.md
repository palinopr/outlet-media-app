...
- Behavior signals: client component/module (14), server action/module (9), calls redirect() (8), calls revalidatePath() (7), defines generateMetadata (3), calls notFound() (3), calls revalidateTag() (1), calls unstable_noStore() (1), sets dynamic rendering mode (1)
