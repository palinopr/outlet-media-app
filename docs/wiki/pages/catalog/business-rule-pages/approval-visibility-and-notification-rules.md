...
- Behavior signals: client component/module (14), server action/module (9), calls redirect() (8), calls revalidatePath() (7), calls notFound() (3), defines generateMetadata (3), sets dynamic rendering mode (1), calls revalidateTag() (1), calls unstable_noStore() (1)
