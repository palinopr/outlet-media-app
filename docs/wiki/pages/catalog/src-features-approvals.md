...
- Used by groups: Tests / Features, src/features / approvals, src/features / campaigns, src/features / dashboard
...
- Defines: approvalMatchesCampaign, mapApproval, buildApprovalListQuery, listApprovalRequests, listCampaignApprovalRequests, APPROVAL_SELECT, approvalReadDb, requestedLimit, shouldOverfetchForScope, effectiveCampaignIds, effectiveCampaignIdSet, approvals, … (+9 more)
