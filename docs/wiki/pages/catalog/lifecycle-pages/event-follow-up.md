...
- Auth signals: references membership/scope access concepts (10), imports Clerk server auth (8), calls currentUser() (4), calls auth() (4), contains explicit access/role guard helper usage (1)
