...
- Auth signals: references membership/scope access concepts (14), imports Clerk server auth (9), calls currentUser() (5), calls auth() (4), contains explicit access/role guard helper usage (1)
