...
- Database objects touched: clients, client_members, if, meta_campaigns, client_accounts, client_member_campaigns, client_access_invites, campaign_client_overrides, admin_activity
