...
- Database objects touched: clients, if, meta_campaigns, client_accounts, client_members, client_member_campaigns, campaign_client_overrides, client_access_invites, system_events, admin_activity
- Direct tests: none
