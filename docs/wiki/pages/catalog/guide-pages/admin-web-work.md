...
- Auth signals: imports Clerk server auth (45), references membership/scope access concepts (29), calls currentUser() (17), calls auth() (5), contains explicit access/role guard helper usage (1)
- Behavior signals: client component/module (62), server action/module (13), calls revalidatePath() (8), calls notFound() (5), sets dynamic rendering mode (5), calls redirect() (5), defines generateMetadata (2), calls revalidateTag() (1), calls unstable_noStore() (1)
