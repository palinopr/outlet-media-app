...
- Auth signals: imports Clerk server auth (30), references membership/scope access concepts (24), calls currentUser() (12), calls auth() (4), contains explicit access/role guard helper usage (1)
