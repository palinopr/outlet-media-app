...
- Auth signals: imports Clerk server auth (40), references membership/scope access concepts (37), calls currentUser() (17), calls auth() (9), contains explicit access/role guard helper usage (1)
- Behavior signals: client component/module (48), server action/module (11), calls redirect() (10), calls revalidatePath() (8), defines generateMetadata (6), calls notFound() (6), sets dynamic rendering mode (3), calls revalidateTag() (1), calls unstable_noStore() (1)
