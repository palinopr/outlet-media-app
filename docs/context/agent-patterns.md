...
If agents return later, they should be reintroduced as a deliberate product decision with a small, event-driven slice, clear approval boundaries, durable ledgers, and tests. Until then, build Campaigns, Events, Reports, approvals, comments, action items, and activity directly in the web product.
